      ...
      <el-col :span="24">
        <el-card shadow="never" class="vel_el_card_override vel_el_card_introduce">
          ...
          <div class="introduce_desc">
            <p class="tit">你好，{{ userNick }}。欢迎使用暴雨洪涝知识图谱平台~</p>
            <p class="tips">
              这是<a :href="githubUrl" target="_blank">本人</a>设计的暴雨洪涝知识图谱平台。<br>
              前端使用VUE框架，后端使用Django框架。<br>点击左侧的按钮来使用吧~<br>
              <a :href="qdUrl" target="_blank">前端仓库</a>（其实复用了之前的项目） <br>
              <a :href="hdUrl" target="_blank">后端仓库</a> <br>
              <a :href="yclUrl" target="_blank">语料预处理仓库</a>
            </p>
          </div>
        </el-card>
      </el-col>
...
const githubUrl = 'https://github.com/Mr-xiu'
